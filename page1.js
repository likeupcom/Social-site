...
    }
    res.json({
      userAccount: { username: dbUser.username, channelUrl: dbUser.TiktokChannel || "https://Tiktok.com/channel_placeholder" },
      appealingPeriod,
      vipChannels,
      regularChannels,
...
    if (!cleanVideoUrl.includes("Tiktok.com") && !cleanVideoUrl.includes("Tiktok")) {
...
    if (dbUser.TiktokChannel && sanitizeTiktokUrl(dbUser.TiktokChannel) !== cleanChannelUrl) {
